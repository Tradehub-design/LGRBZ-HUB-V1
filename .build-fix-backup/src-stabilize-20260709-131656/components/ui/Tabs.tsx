        ...
        return (
          <button
            ...
            className={cn(
              ...
              active
                ? "bg-white text-slate-950 shadow-sm transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
